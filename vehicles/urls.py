...
urlpatterns = [
    ...
    path("availability/", views.get_vehicle_availabilities),
    path("availability/create/", views.create_vehicle_availability),
    path("availability/update/<int:availabilityId>/", views.update_vehicle_availability),
    path("availability/delete/<int:availabilityId>/", views.delete_vehicle_availability),
